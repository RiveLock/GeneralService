package com.happy.exercise.config;
...
public class CodeGenerator {
     ...
     * 包名，最终生成路径
     */
    private static final String PAKEGE_NAME = "com.happy.exercise.business";

    /**
     * 数据库链接
     */
    private static final String JDBC = "jdbc:mysql://localhost:3306/exercise?characterEncoding=UTF8";
